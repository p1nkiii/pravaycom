...
export default function PassionTestLanding() {
  return (
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center">
            ...
            >
              Find Your{' '}
              <span className="text-sky-500">True Passion</span>
            </motion.h1>
            ...
            >
              <a 
                ...
                className="bg-sky-500 text-white px-12 py-4 rounded-lg text-xl font-semibold hover:bg-sky-600 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
              >
                How It Works
              </a>
            </motion.div>
            ...
            >
              <p>{`Join others who've discovered their passion`}</p>
            </motion.div>
          </div>
        </div>
